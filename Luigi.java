...
* Description:  Begins the Luigi game
*/	
package FinalProject;
...
public class Luigi extends JFrame implements KeyListener
{
...
String marioImage = "Luigi.png";//setting the variable for mario image
...
String backgroundImage = "background.png";//setting the variable for the background image
    ...
    public Luigi()   //to the name of your class
    {
			...
			public void keyPressed(KeyEvent e) {
				...
				case 's':
					...
					marioImage ="luigi crouch.png";//crouch image
				...
				if(cordX >= -4000)//if it is in the map
				{
					if(((marioX >= (pipeX + 50)|| marioX <=(pipeX + -150)))|| marioY <= 600)//if infront or behind pipe
					{
						...
						{
							marioImage = "luigi run left.png";
							cordX -= 20;
							goombaX -= 20;
							pipeX -= 20;
							brickX -= 20;
							coinX -= 20;
							marioImage = "luigi run.png";
							//map moves forward
							//mario jumps
							//goomba comes closer
							//pipe comes closer
			...
			public void keyReleased(KeyEvent e) {
				...
				marioImage = "luigi.png";//mario returns to standing form
				repaint();
